 ...
 */
final class Version20220327114913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercice (id INT AUTO_INCREMENT NOT NULL, bibliotheque_id INT NOT NULL, description LONGTEXT NOT NULL, duree INT NOT NULL, repetition INT NOT NULL, type VARCHAR(255) NOT NULL, experience INT NOT NULL, INDEX IDX_E418C74D4419DE7D (bibliotheque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
